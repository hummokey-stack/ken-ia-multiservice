...
Je m'appelle Ken et je vis à Douala, Cameroun. Je suis indépendant en train de lancer une agence digitale spécialisée dans les solutions sur mesure : création de sites web, développement d'applications, intégration IA, automatisation et création de contenu avec l'IA.

Mes objectifs prioritaires actuels sont de décrocher mes premiers clients, atteindre plus de 2 millions FCFA de chiffre d'affaires, et monétiser via TikTok.

À long terme, je veux bâtir une agence de référence en Afrique centrale avec une équipe IA automatisée et une clientèle européenne significative (France, Belgique, Suisse en priorité).

Le domaine où j'ai besoin du plus d'aide en ce moment : création de contenu et développement web technique.
